...
# return the file list with unwanted symbols removed
def get_file_list(filename, filetype, file_line_count):
...
def cmbine_2day(filename1, filename2, filetype):
    ...
    file1=get_file_list(filename1, filetype, file1_line_count)
    ...
    new_file1=get_file_list(filename1, filetype, new_file1_line_count)
...
def final_combine(date):
    ...
    twse=get_file_list(date, "twse", twse_count)
    tpex=get_file_list(date, "tpex", tpex_count)
    total=twse+tpex
    import os
